...
import (
  ...
  services "taoniu.local/admin/cryptos/grpc/services/binance/futures/indicators/daily"
  repositories "taoniu.local/admin/cryptos/repositories/binance/futures/indicators/daily"
)
